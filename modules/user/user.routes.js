...
const { registerUser, getAllUsers, loginUser, getSchoolAlumni, getHeadmasters, deleteUser, updateUser, alumniCount, getHash, alumniCountPerSchool, sendMail, sendEmail, pushSMS, getAllAlumni } = require("./user.controller");
