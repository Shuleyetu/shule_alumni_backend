...
const { registerUser, getAllUsers, loginUser, getSchoolAlumni, getHeadmasters, deleteUser, updateUser, alumniCount, getHash, alumniCountPerSchool, sendMail, sendEmail, pushSMS, getAllAlumni, sendPasswordLink, passwordReset, sendMessage, addGallery, deleteGallery, getUserFullInformation, allUsers } = require("./user.controller");
